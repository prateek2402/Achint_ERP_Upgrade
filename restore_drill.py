...
def _import_app_against_sandbox(sandbox_db: Path):
    ...
    # Routers bind get_current_user / get_db from `main` at import time.
    # Evict them with main so a re-import does not keep validating JWTs
    # against a stale SECRET_KEY from a previous drill (or the live app).
